 ...
 * @param {object} props - The dialog properties have a title and content.
  ...
  dialog.innerHTML = `
    <div class="dialog-container">
      <div class="dialog-header">
        <h2 class="headline-small dialog-title text-o-surface">
          ${props.title}
        </h2>
      ...
      <div class="dialog-actions">
        ...
        <a href="/register" class="btn btn-fill" data-dialog-toggler>
          <p class="label-large">Create an account</p>
          <div class="state-layer"></div>
        </a>
      </div>
    </div>
